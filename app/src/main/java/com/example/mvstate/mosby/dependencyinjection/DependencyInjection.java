...
package com.example.mvstate.mosby.dependencyinjection;

import com.example.mvstate.mosby.businesslogic.ShoppingCart;
import com.example.mvstate.mosby.businesslogic.feed.GroupedPagedFeedLoader;
import com.example.mvstate.mosby.businesslogic.feed.HomeFeedLoader;
import com.example.mvstate.mosby.businesslogic.feed.PagingFeedLoader;
import com.example.mvstate.mosby.businesslogic.http.ProductBackendApi;
import com.example.mvstate.mosby.businesslogic.http.ProductBackendApiDecorator;
import com.example.mvstate.mosby.businesslogic.interactor.details.DetailsInteractor;
import com.example.mvstate.mosby.businesslogic.interactor.search.SearchInteractor;
import com.example.mvstate.mosby.businesslogic.searchengine.SearchEngine;
import com.example.mvstate.mosby.view.category.CategoryPresenter;
import com.example.mvstate.mosby.view.checkoutbutton.CheckoutButtonPresenter;
import com.example.mvstate.mosby.view.detail.ProductDetailsPresenter;
import com.example.mvstate.mosby.view.home.HomePresenter;
import com.example.mvstate.mosby.view.menu.MainMenuPresenter;
import com.example.mvstate.mosby.view.search.SearchPresenter;
import com.example.mvstate.mosby.view.selectedcounttoolbar.SelectedCountToolbarPresenter;
import com.example.mvstate.mosby.view.shoppingcartlabel.ShoppingCartLabelPresenter;
import com.example.mvstate.mosby.view.shoppingcartoverview.ShoppingCartOverviewItem;
import com.example.mvstate.mosby.view.shoppingcartoverview.ShoppingCartOverviewPresenter;
